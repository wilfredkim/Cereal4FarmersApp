...
public class PayActivity extends AppCompatActivity {
   ...
   // public String myPreferences;
    String s1,s2,s3,s5,s6,price;
    int q;

    FertilizerbookingActivity fertilizerbookingActivity;
    SeedsbookingActivity  seed;
    EditText Brand,Quantity,Phone;
    EditText Tprice,Mquatity,Mprice;
    Button Decline;
    ImageView Accept;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            price = seed.sharedPreferences.getString(seed.pp1, "");
            ...
            q = Integer.parseInt(s2);
                ...
                s6 = "320 *" +  Quantity.getText().toString();
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (confirm != null) {
                    try {
                        ...
                        startActivity(new Intent(this, ConfirmationseedActivity.class)
