...
public class SeedsmenuActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    public static final String TAG_ITEMBRAND = "Brand";
    public static final String TAG_ITEMQ = "Quantity";
    public static final String TAG_PRICE = "Price";
    //public static final String TAG_LONGITUDE="Longitude";
    private ProgressDialog pDialog;
   // private static final String url_seed = "http://192.168.43.189:9000/backnews";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seedsmenu);
    ...
    class GetLocationByCategoryClicked extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(SeedsmenuActivity.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            JSONArray jsonArray;
            jsonArray = jsonParser.makeHttpRequest(Utility.url_seed, "GET", news);
            ...
            if (jsonArray != null) {
                ...
                Toast.makeText(SeedsmenuActivity.this, "No news in this Category", Toast.LENGTH_SHORT).show();
            }
            return null;
        ...
        protected void onPostExecute(Void result) {
           ...
           /* else {*/
                ListAdapter adapter = new SimpleAdapter(
                        SeedsmenuActivity.this, itemList,
                        R.layout.seedmenuevent, new String[]{
                ...
                try {
                    if (adapter.getCount() != 0) {
                        ...
                        final ListView listView = (ListView) findViewById(R.id.eventseed);
